...
const AboutHero = () => {
  ...
  const comp1 = {
    comp1Name: ctx.lang === 'en' ? 'Digital Product Designer' : 'مصمم منتجات رقمية',
      ...
      <Container>
        ...
        <Row>
          <motion.div
            ...
            transition={{type: 'spring', duration: 1.5, bounce: .5, delay: .6}} 
            className="col-12 col-lg-6"
          >
            <img src="./assets/aboutProf.svg" />
          </motion.div>
          <div className="col-12 col-lg-6">
            ...
            >
              ...
              >
                {t('Hello_There')}<HiIcon/><SmileIcon/>
              </motion.h3>
              <motion.p
                initial={{opacity: 0, y: 400}}
                animate={{opacity: 1, y: 0}}
              ...
              >
                {t("I'm_Mustafa_Kamel")} <a target='_blank' href={comp1.comp1Url}>{comp1.comp1Name}</a> {t('based_in_Egypt')} <a target='_blank' href={comp2.comp2Url}>{comp2.comp2Name}</a>{t('I’d_love_to')}</motion.p>
            </motion.div>
          </div>
        </Row>
      </Container>
