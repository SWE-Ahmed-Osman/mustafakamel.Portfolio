...
const Testimonials = () => {
  ...
  const settings = {
    ...
    prevArrow: <PrevButton img={DUMMY_USERS[currentIndex].src} slider={sliderRef}/>,
    nextArrow: <NextButton img={DUMMY_USERS[currentIndex].src} slider={sliderRef}/>,
      ...
      <Container ref={ref}>
        <div className="header-testimonial">
          ...
          <Slider ref={sliderRef} {...settings}>
            {DUMMY_USERS.map(user => <SingleFeedBack key={user.id} {...user}/>)}
          </Slider>
        </ScrollTransition>
      </Container>
    </section>
